...
#ifdef BUILD_LK
	printf("[NT51021]lcm_init func:LK akx123 nt51021 3rd inx lcm init ok!\n");
#else
	printk("[NT51021]lcm_init func:Kernel akx123 nt51021 3rd inx lcm init ok!\n");
#endif
}
...
#endif
	MDELAY(10);
	printk("[NT51021]lcm_suspend func:Kernel akx123 nt51021 3rd inx lcm suspend ok!\n");
}

static void lcm_resume(void)
{
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	printk("[NT51021]lcm_init func:Kernel akx123 nt51021 3rd inx lcm resume ok!\n");
}
