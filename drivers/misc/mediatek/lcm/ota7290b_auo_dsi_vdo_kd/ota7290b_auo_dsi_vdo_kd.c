...
#ifdef BUILD_LK
	printf("[OTA7290B]lcm_init func:LK akx123 ota7290b lcm init ok!\n");
#else
	printk("[OTA7290B]lcm_init func:Kernel akx123 ota7290b lcm init ok!\n");
#endif
}
...
#endif
	MDELAY(10);
	printk("[OTA7290B]lcm_suspend func:Kernel akx123 ota7290b AUO lcm suspend ok!\n");
}

static void lcm_resume(void)
{
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	printk("[OTA7290B]lcm_init func:Kernel akx123 ota7290b auo lcm resume ok!\n");
}
