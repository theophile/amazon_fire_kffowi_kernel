...
#ifdef BUILD_LK
	printf("[NT51021]lcm_init func:LK akx123 nt51021 1st lcm init ok!\n");
#else
	printk("[NT51021]lcm_init func:Kernel akx123 nt51021 1st lcm init ok!\n");
#endif
}
...
static void lcm_suspend(void)
{
	...
	printk("[NT51021]lcm_suspend func:Kernel akx123 nt51021 1st lcm suspend!\n");
}
...
{
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	printk("[NT51021]lcm_init func:Kernel akx123 nt51021 1st lcm resume ok!\n");
}
